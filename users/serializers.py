...
class UserCredentialSerializer(serializers.Serializer):
    ...
    def validate_password_confirm(self, value):
        ...
        if password != value:
            # raise ValidationError("The passwords must match") # similar to above
    ...
    def validate_username(self, value):
        ...
        if username != value:
            raise ValidationError("The passwords must match")  # similar to above
            # raise serializers.ValidationError("Username provided is invalid")
        return value
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ('gender', 'image', 'phone_number', 'is_approved')
